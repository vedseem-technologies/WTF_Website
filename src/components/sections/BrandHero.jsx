      ...
      <div className="sticky top-0 h-screen w-full overflow-hidden flex items-center justify-center">
        ...
        >
          ...
          <div className="relative z-10 flex flex-col items-center max-w-sm md:max-w-3xl lg:max-w-5xl">
            ...
            >
              <Image src="/logo_orig.png" alt="WTF Logo" width={180} height={180} className="object-contain" />
            </motion.div>
            ...
            <p className="text-xl lg:text-2xl xl:text-3xl text-zinc-300 max-w-4xl font-light mb-12"
              style={{
                lineHeight: '1.2',
              }}
            >
              Disrupt the QSR industry with India's most aggressive food movement. This isn't just a franchise; it's a culinary powerhouse.
            </p>
            <motion.button
              whileHover={{ scale: 1.05, backgroundColor: "#fff", color: "#D62828" }}
              whileTap={{ scale: 0.95 }}
        ...
        >
          <div className="absolute inset-0 w-[200%] h-full">
            <Image src="/hero-brand.webp" alt="WTF Hero" fill priority className="object-cover" />
          </div>
        </motion.div>
        ...
        <motion.div style={{ opacity: swipeDownOpacity }} className="absolute bottom-8 left-1/2 -translate-x-1/2 z-20 flex flex-col items-center gap-2">
          <span className="text-white text-lg font-bold tracking-[0.3em] uppercase opacity-60">
            Scroll to Enter
          </span>
          <motion.div animate={{ y: [0, 8, 0] }} transition={{ duration: 1.5, repeat: Infinity }} className="text-white text-3xl">
            ↓
          </motion.div>
        </motion.div>
      </div>
    ...
    <section ref={ref} className="py-24 md:py-40 bg-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-8 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
        <div className="relative">
          ...
          >
            <Image src="/c1.jpg.jpeg" alt="The WTF Vibe" fill className="object-cover" />
          </motion.div>
          <motion.div 
          ...
          >
            <Image src="/c2.jpg.jpeg" alt="The Roll-X Secret" fill className="object-cover" />
          </motion.div>
        </div>
        ...
        >
          <div className="flex items-center gap-2 mb-4 md:mb-0">
            ...
            <span className="text-[#D62828] font-black uppercase tracking-widest text-md lg:text-2xl">Our Identity</span>
          </div>
          ...
          <p className="text-xl md:text-xl lg:text-2xl text-zinc-700 leading-relaxed font-medium">
            WTF Foods isn't a kitchen; it's a movement. We've cracked the code of India's street-food obsession and transformed it into a scalable, high-tech culinary engine. 
          </p>
          <p className="text-lg md:text-xl lg:text-2xl text-zinc-500 leading-relaxed">
            Our Roll-X range has redefined the Kathi Roll forever. We don't follow trends—we set them, one explosive flavor at a time.
          </p>
          <div className="grid grid-cols-2 gap-10 pt-2 lg:pt-6">
            <div className="flex flex-col">
              <span className="lg:text-6xl md:text-5xl text-4xl font-black text-[#D62828] leading-none md:mb-2">100%</span>
              <span className="lg:text-lg md:text-md text-sm mt-2 lg:font-bold md:font-medium font-medium uppercase text-zinc-400 tracking-widest">Growth Retention</span>
            </div>
            <div className="flex flex-col">
              <span className="lg:text-6xl md:text-5xl text-4xl font-black text-zinc-950 leading-none md:mb-2">Zero</span>
              <span className="lg:text-lg md:text-md text-sm mt-2 lg:font-bold md:font-medium font-medium uppercase text-zinc-400 tracking-widest">Royalty Drama</span>
            </div>
          </div>
        </motion.div>
      </div>
  ...
  const benefits = [
    {
      ...
      icon: (
        <svg className="w-10 h-10 text-[#D62828]" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="1.5">
      ...
      <div className="max-w-[90%] mx-auto px-4 sm:px-8">
        <div className="flex flex-col md:flex-row justify-between items-center md:items-end mb-10 lg:mb-20 gap-10">
          <div className="flex flex-col gap-4 items-center md:items-start text-center md:text-left">
            <span className="text-[#D62828] font-bold uppercase tracking-widest text-sm lg:text-xl">Strategic Partnership</span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          <div className="flex flex-col gap-12 order-2 lg:order-1">
            <div className="flex flex-col gap-6">
              ...
              <p className="text-zinc-500 text-lg md:text-xl leading-relaxed mb-4">
                We've eliminated the legacy baggage of old-school food franchises:
              </p>
              <ul className="flex flex-col gap-4">
                {[
                  "Absolute 0% Royalty on all sales—always.",
                  "Exclusive Access to handcrafted Roll-X secret recipes.",
                  "Data-Driven inventory algorithms for zero waste.",
                  "Automated Digital Ad machine focused on your radius."
                ].map((item, i) => (
                  <li key={i} className="flex gap-4 lg:text-xl text-zinc-800 lg:font-semibold leading-[1.1] items-center">
                    <span className="w-8 h-8 rounded-lg bg-red-50 text-[#D62828] flex items-center justify-center shrink-0 text-sm">✓</span>
                    {item}
                  </li>
                ))}
              </ul>
          ...
          >
            <div className="relative rounded-[2.5rem] overflow-hidden border-[7px] border-[#D62828] shadow-[0_30px_60px_-15px_rgba(214,40,40,0.4)] aspect-[4/5] w-full max-w-[550px] mx-auto">
              <Image src="/our-food-menu.jpg" alt="WTF Mastery" fill className="object-cover" />
