...
export default function ServicePage({ params }) {
  ...
  // Filter menu items for this service
            ...
            {filteredItems.length > 0 ? (
              ...
              >
                ...
                <p className="text-gray-500 max-w-md mx-auto">
                  We're currently curating the best {service.name} packages for you. Check back soon!
                </p>
              ...
              <div className="space-y-6 px-8 py-6">
               ...
               <div>
                ...
                <button
                  ...
                  className="mt-4 flex w-full items-center justify-center rounded-2xl bg-red-600 px-6 py-4 text-2xl font-bold text-white shadow-lg shadow-red-200 transition hover:bg-red-700 active:scale-[0.98]"
                >
